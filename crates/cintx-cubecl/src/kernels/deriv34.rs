...
enum Op {
    ...
    DI { dst: usize, src: usize, i_off: u32, j_off: u32 },
    /// `G2E_D_J(dst, src, i_l+i_off, j_l+j_off, ...)` — ket-center derivative.
    DJ { dst: usize, src: usize, i_off: u32, j_off: u32 },
}
...
const OPS_IPIPIP: [Op; 7] = [
    Op::DI { dst: 1, src: 0, i_off: 2, j_off: 0 },
    Op::DI { dst: 2, src: 0, i_off: 1, j_off: 0 },
    Op::DI { dst: 3, src: 1, i_off: 1, j_off: 0 },
    Op::DI { dst: 4, src: 0, i_off: 0, j_off: 0 },
    Op::DI { dst: 5, src: 1, i_off: 0, j_off: 0 },
    Op::DI { dst: 6, src: 2, i_off: 0, j_off: 0 },
    Op::DI { dst: 7, src: 3, i_off: 0, j_off: 0 },
];
// ipipnucip / ipiprinvip: D_J first (ket), then D_I (bra ∇∇).
const OPS_IPIPNUCIP: [Op; 7] = [
    Op::DJ { dst: 1, src: 0, i_off: 2, j_off: 0 },
    Op::DI { dst: 2, src: 0, i_off: 1, j_off: 0 },
    Op::DI { dst: 3, src: 1, i_off: 1, j_off: 0 },
    Op::DI { dst: 4, src: 0, i_off: 0, j_off: 0 },
    Op::DI { dst: 5, src: 1, i_off: 0, j_off: 0 },
...
const S27: [(usize, usize, usize); 27] = [
    (7, 0, 0), (6, 1, 0), (6, 0, 1), (5, 2, 0), (4, 3, 0), (4, 2, 1), (5, 0, 2), (4, 1, 2),
    (4, 0, 3), (3, 4, 0), (2, 5, 0), (2, 4, 1), (1, 6, 0), (0, 7, 0), (0, 6, 1), (1, 4, 2),
    (0, 5, 2), (0, 4, 3), (3, 0, 4), (2, 1, 4), (2, 0, 5), (1, 2, 4), (0, 3, 4), (0, 2, 5),
    (1, 0, 6), (0, 1, 6), (0, 0, 7),
];
...
const OPS_IPIPIPIPRINV: [Op; 15] = [
    Op::DI { dst: 1, src: 0, i_off: 3, j_off: 0 },
    Op::DI { dst: 2, src: 0, i_off: 2, j_off: 0 },
    Op::DI { dst: 3, src: 1, i_off: 2, j_off: 0 },
    Op::DI { dst: 4, src: 0, i_off: 1, j_off: 0 },
    Op::DI { dst: 5, src: 1, i_off: 1, j_off: 0 },
    Op::DI { dst: 6, src: 2, i_off: 1, j_off: 0 },
    Op::DI { dst: 7, src: 3, i_off: 1, j_off: 0 },
    Op::DI { dst: 8, src: 0, i_off: 0, j_off: 0 },
    Op::DI { dst: 9, src: 1, i_off: 0, j_off: 0 },
    Op::DI { dst: 10, src: 2, i_off: 0, j_off: 0 },
    Op::DI { dst: 11, src: 3, i_off: 0, j_off: 0 },
    Op::DI { dst: 12, src: 4, i_off: 0, j_off: 0 },
    Op::DI { dst: 13, src: 5, i_off: 0, j_off: 0 },
    Op::DI { dst: 14, src: 6, i_off: 0, j_off: 0 },
    Op::DI { dst: 15, src: 7, i_off: 0, j_off: 0 },
];
// ipiprinvipip: D_J, D_J(ket+1), D_J(on g2), then D_I — ket ∇∇ + bra ∇∇.
const OPS_IPIPRINVIPIP: [Op; 15] = [
    Op::DJ { dst: 1, src: 0, i_off: 2, j_off: 0 },
    Op::DJ { dst: 2, src: 0, i_off: 2, j_off: 1 },
    Op::DJ { dst: 3, src: 2, i_off: 2, j_off: 0 },
    Op::DI { dst: 4, src: 0, i_off: 1, j_off: 0 },
    Op::DI { dst: 5, src: 1, i_off: 1, j_off: 0 },
    Op::DI { dst: 6, src: 2, i_off: 1, j_off: 0 },
    Op::DI { dst: 7, src: 3, i_off: 1, j_off: 0 },
...
const OPS_IPIPIPRINVIP: [Op; 15] = [
    Op::DJ { dst: 1, src: 0, i_off: 3, j_off: 0 },
    Op::DI { dst: 2, src: 0, i_off: 2, j_off: 0 },
    Op::DI { dst: 3, src: 1, i_off: 2, j_off: 0 },
    Op::DI { dst: 4, src: 0, i_off: 1, j_off: 0 },
    Op::DI { dst: 5, src: 1, i_off: 1, j_off: 0 },
...
const S81: [(usize, usize, usize); 81] = [
    (15, 0, 0), (14, 1, 0), (14, 0, 1), (13, 2, 0), (12, 3, 0), (12, 2, 1), (13, 0, 2),
    (12, 1, 2), (12, 0, 3), (11, 4, 0), (10, 5, 0), (10, 4, 1), (9, 6, 0), (8, 7, 0), (8, 6, 1),
    (9, 4, 2), (8, 5, 2), (8, 4, 3), (11, 0, 4), (10, 1, 4), (10, 0, 5), (9, 2, 4), (8, 3, 4),
    (8, 2, 5), (9, 0, 6), (8, 1, 6), (8, 0, 7), (7, 8, 0), (6, 9, 0), (6, 8, 1), (5, 10, 0),
    (4, 11, 0), (4, 10, 1), (5, 8, 2), (4, 9, 2), (4, 8, 3), (3, 12, 0), (2, 13, 0), (2, 12, 1),
    (1, 14, 0), (0, 15, 0), (0, 14, 1), (1, 12, 2), (0, 13, 2), (0, 12, 3), (3, 8, 4), (2, 9, 4),
    (2, 8, 5), (1, 10, 4), (0, 11, 4), (0, 10, 5), (1, 8, 6), (0, 9, 6), (0, 8, 7), (7, 0, 8),
    (6, 1, 8), (6, 0, 9), (5, 2, 8), (4, 3, 8), (4, 2, 9), (5, 0, 10), (4, 1, 10), (4, 0, 11),
    (3, 4, 8), (2, 5, 8), (2, 4, 9), (1, 6, 8), (0, 7, 8), (0, 6, 9), (1, 4, 10), (0, 5, 10),
    (0, 4, 11), (3, 0, 12), (2, 1, 12), (2, 0, 13), (1, 2, 12), (0, 3, 12), (0, 2, 13),
    (1, 0, 14), (0, 1, 14), (0, 0, 15),
];
const PERM_IPIPIPIPRINV: [usize; 81] = [
    0, 27, 54, 9, 36, 63, 18, 45, 72, 3, 30, 57, 12, 39, 66, 21, 48, 75, 6, 33, 60, 15, 42, 69,
    24, 51, 78, 1, 28, 55, 10, 37, 64, 19, 46, 73, 4, 31, 58, 13, 40, 67, 22, 49, 76, 7, 34, 61,
    16, 43, 70, 25, 52, 79, 2, 29, 56, 11, 38, 65, 20, 47, 74, 5, 32, 59, 14, 41, 68, 23, 50, 77,
...
const PERM_IPIPIPRINVIP: [usize; 81] = [
    ...
    73, 74, 3, 4, 5, 30, 31, 32, 57, 58, 59, 12, 13, 14, 39, 40, 41, 66, 67, 68, 21, 22, 23, 48, 49,
    50, 75, 76, 77, 6, 7, 8, 33, 34, 35, 60, 61, 62, 15, 16, 17, 42, 43, 44, 69, 70, 71, 24, 25, 26,
    51, 52, 53, 78, 79, 80,
];
        ...
        for n in 0..nrys {
            ...
            for op in spec.ops {
                let (src, dst, is_di, i_off, j_off) = match *op {
                    Op::DI { dst, src, i_off, j_off } => (src, dst, true, i_off, j_off),
                    Op::DJ { dst, src, i_off, j_off } => (src, dst, false, i_off, j_off),
                };

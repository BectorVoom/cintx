...
moment_parity_test!(
    ...
    vendor_int1e_rr_sph, vendor_int1e_rr_cart, "int1e_rr"
);
moment_parity_test!(
    test_int1e_r2_parity, 1,
    INT1E_R2_SPH, INT1E_R2_CART,
    vendor_int1e_r2_sph, vendor_int1e_r2_cart, "int1e_r2"
);
moment_parity_test!(
    test_int1e_z_parity, 1,
    INT1E_Z_SPH, INT1E_Z_CART,
    vendor_int1e_z_sph, vendor_int1e_z_cart, "int1e_z"
);
moment_parity_test!(
    test_int1e_zz_parity, 1,
    INT1E_ZZ_SPH, INT1E_ZZ_CART,

...
impl CintxRawApi {
    fn from_i32(value: i32) -> Option<Self> {
        match value {
            ...
            25 => Some(Self::Int1eIpovlpSpinor),
            26 => Some(Self::Int1eIpkinCart),
            27 => Some(Self::Int1eIpkinSph),
            28 => Some(Self::Int1eIpkinSpinor),
            29 => Some(Self::Int1eIpnucCart),
            30 => Some(Self::Int1eIpnucSph),
            31 => Some(Self::Int1eIpnucSpinor),
            32 => Some(Self::Int1eIprinvCart),
            33 => Some(Self::Int1eIprinvSph),
            34 => Some(Self::Int1eIprinvSpinor),
            35 => Some(Self::Int2eIp1Cart),
            36 => Some(Self::Int2eIp1Sph),
            37 => Some(Self::Int2eIp1Spinor),
            38 => Some(Self::Int1eEcpIprinvCart),
            39 => Some(Self::Int1eEcpIprinvSph),
            _ => None,
        }
    }
    ...
    fn raw_id(self) -> RawApiId {
        match self {
            ...
            Self::Int1eIpovlpSpinor => RawApiId::INT1E_IPOVLP_SPINOR,
            Self::Int1eIpkinCart => RawApiId::INT1E_IPKIN_CART,
            Self::Int1eIpkinSph => RawApiId::INT1E_IPKIN_SPH,
            Self::Int1eIpkinSpinor => RawApiId::INT1E_IPKIN_SPINOR,
            Self::Int1eIpnucCart => RawApiId::INT1E_IPNUC_CART,
            Self::Int1eIpnucSph => RawApiId::INT1E_IPNUC_SPH,
            Self::Int1eIpnucSpinor => RawApiId::INT1E_IPNUC_SPINOR,
            Self::Int1eIprinvCart => RawApiId::INT1E_IPRINV_CART,
            Self::Int1eIprinvSph => RawApiId::INT1E_IPRINV_SPH,
            Self::Int1eIprinvSpinor => RawApiId::INT1E_IPRINV_SPINOR,
            Self::Int2eIp1Cart => RawApiId::INT2E_IP1_CART,
            Self::Int2eIp1Sph => RawApiId::INT2E_IP1_SPH,
            Self::Int2eIp1Spinor => RawApiId::INT2E_IP1_SPINOR,
            Self::Int1eEcpIprinvCart => RawApiId::INT1E_ECP_IPRINV_CART,
            Self::Int1eEcpIprinvSph => RawApiId::INT1E_ECP_IPRINV_SPH,
        }
    }

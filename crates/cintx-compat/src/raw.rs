...
impl RawApiId {
    ...
    pub const INT3C2E_CART: Self = Self::Symbol("int3c2e_cart");
    pub const INT3C2E_SPH: Self = Self::Symbol("int3c2e_sph");
    pub const INT3C2E_SPINOR: Self = Self::Symbol("int3c2e_spinor");

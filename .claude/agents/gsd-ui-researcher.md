...
Use template from `/home/chemtech/workspace/cintx/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/chemtech/workspace/cintx/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/chemtech/workspace/cintx/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

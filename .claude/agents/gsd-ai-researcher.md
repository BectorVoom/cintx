...
<required_reading>
Read `/home/user/Documents/workspace/cintx/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>

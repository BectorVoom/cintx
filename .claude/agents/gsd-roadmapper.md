...
Reference full template: `/home/chemtech/workspace/cintx/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/chemtech/workspace/cintx/.claude/get-shit-done/templates/state.md`.

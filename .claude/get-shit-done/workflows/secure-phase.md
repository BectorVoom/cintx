...
```
Agent(
  prompt="Read /home/user/Documents/workspace/cintx/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Documents/workspace/cintx/.claude/get-shit-done/templates/SECURITY.md`

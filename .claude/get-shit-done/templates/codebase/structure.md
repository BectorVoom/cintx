...
- Usage: Reference from command with `@/home/chemtech/workspace/cintx/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/chemtech/workspace/cintx/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/chemtech/workspace/cintx/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

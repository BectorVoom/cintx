...
- [ ] 27-05-PLAN.md (wave 4) — ⚠ NEEDS RE-PLAN before execution: original scope flips oracle_covered for 24 families, but 4 arms (int2c2e_ip1/ip2 + int3c1e_ip1/iprinv spinor) are now deferred (upstream vendor stubs, 2026-05-31 pause-and-re-plan decision) and MUST stay false. Re-scope to flip only byte-identity-achievable families (1e ranks + int3c2e_ip1), then update R5/D-03 note, complete D-10 no-silent-skip assertion, manifest-audit green.

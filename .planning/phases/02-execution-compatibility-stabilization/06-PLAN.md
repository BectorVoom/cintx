...
must_haves:
  ...
  key_links:
    - from: crates/cintx-compat/src/raw.rs
      ...
      via: "Validated raw calls instantiate `CubeClExecutor` through the explicit compat-to-CubeCL dependency before delegating into runtime evaluation."
      pattern: "CubeClExecutor"
    - from: crates/cintx-compat/src/raw.rs
